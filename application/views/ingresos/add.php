...
<div class="row" id="form" style="padding-left:15px;padding-right:15px;">
      ...
      <div class="box-body">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group" style="margin-bottom: 0px;">
            ...
            <div class="col-sm-8 col-xs-8">              
              <select class="form-control" id="idperiodo_pago" name="idperiodo_pago" onchange="estado_pago_udpate();"> 
          ...
          <div class="form-group" style="margin-bottom: 0px;">
            <div class="col-sm-4 col-xs-4"> 
              <label for="estado_pago" class="control-label">Estado </label>  
            </div>
            <div class="col-sm-8 col-xs-8">              
              <select class="form-control" id="estado_pago" name="estado_pago" disabled="disabled" onchange="estado_pago_udpate();">
                  <option value="cancelado">Cancelado</option>
                  <option value="debe">Debe</option>
              </select>             
            </div>
          </div>  
          <div class="form-group" id="div_fecha_pago" style="display: none;">
            <div class="col-sm-4 col-xs-4"> 
  ...
  <div class="col-md-12">
    <div class="box box-success">
      <div class="box-header with-border" id="data_detalle_ingreso">
