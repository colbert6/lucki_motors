...
class Proformas extends MY_Controller {
    ...
    {   
        ...
        $data_usuario_receptor = array('Cliente' => array($proforma['Cliente'],'4'),
                                  'RUC/DNI' => array($proforma['RUC/DNI'],'1'),
                                  'Dirección' => array($proforma['Direccion'],'5')  );
        $pdf->receptor_data( 5 ,$data_usuario_receptor);

        $data_comprobante = array('Emitido' => array($proforma['Fecha'],'1'),
                                  'Tienda' => array($proforma['Tienda'],'1'),  
                                  'Vendedor' => array($proforma['Usuario'],'1'),
                                  'Comprobante' => array($proforma['Comprobante'],'1'),
                                  'Tipo pago' => array($proforma['Tipo_pago'],'1'),
